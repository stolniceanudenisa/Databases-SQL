...
create table plantratament(id_plan int primary key,id_client int foreign key references client(id_client),id_tratament int foreign key references tratament(id_tratament),datat date)
...
INSERT INTO plantratament(id_plan, id_client, id_tratament, datat) VALUES 
(1,1,1,'2022-01-01'),
(2, 4, 1, '2022-01-01'),
(3, 3, 2,'2022-01-01'),
(4, 4, 3, '2022-03-01'),
